...
for directory_path in glob.glob("path_to_train_images"):
...
for directory_path in glob.glob("path_for_test_images"):
...
df.to_csv(r'path/output_knn_test.csv', index = False)
